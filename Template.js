...
var _user$project$Examples_Template$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Examples_Template$init = function (floatSeed) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		0,
		{ctor: '[]'});
};
var _user$project$Examples_Template$padding = 20;
var _user$project$Examples_Template$w = 500;
var _user$project$Examples_Template$h = 500;
var _user$project$Examples_Template$view = function (model) {
	return A4(
		_user$project$Canvas$element,
		_user$project$Examples_Template$w,
		_user$project$Examples_Template$h,
		{
			ctor: '::',
		...
		A5(
			_user$project$Canvas$fillText,
			_elm_lang$core$Basics$toString(model),
			_user$project$Examples_Template$w / 2,
			_user$project$Examples_Template$h / 2,
			_elm_lang$core$Maybe$Nothing,
			A2(
				_user$project$Canvas$fillStyle,
				A3(_elm_lang$core$Color$rgb, 255, 0, 0),
				A2(
					_user$project$Canvas$textAlign,
					_user$project$Canvas$Center,
					A2(
						_user$project$Canvas$font,
						'48px sans-serif',
						A5(_user$project$Canvas$clearRect, 0, 0, _user$project$Examples_Template$w, _user$project$Examples_Template$h, _user$project$Canvas$empty))))));
};
var _user$project$Examples_Template$AnimationFrame = function (a) {
	return {ctor: 'AnimationFrame', _0: a};
};
var _user$project$Examples_Template$subscriptions = function (model) {
	return _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Examples_Template$AnimationFrame);
};
var _user$project$Examples_Template$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Examples_Template$init, update: _user$project$Examples_Template$update, subscriptions: _user$project$Examples_Template$subscriptions, view: _user$project$Examples_Template$view})(_elm_lang$core$Json_Decode$float);

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['Template'] = Elm['Examples']['Template'] || {};
if (typeof _user$project$Examples_Template$main !== 'undefined') {
    _user$project$Examples_Template$main(Elm['Examples']['Template'], 'Examples.Template', undefined);
}
