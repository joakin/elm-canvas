...
var _user$project$Examples_TiledLines$drawLine = F2(
	function (_p0, cmds) {
		var _p1 = _p0;
		return A3(
			...
			_p1._1._0,
			_p1._1._1,
			A3(_user$project$Canvas$moveTo, _p1._0._0, _p1._0._1, cmds));
	});
	...
	function (seed, i, cmds) {
		...
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(i, _user$project$Examples_TiledLines$cols * _user$project$Examples_TiledLines$rows) > 0) {
				...
				var line = _p3._0;
				var seed2 = _p3._1;
				var lineCmds = A2(_user$project$Examples_TiledLines$drawLine, line, cmds);
				var _v2 = seed2,
					_v3 = i + 1,
					_v4 = lineCmds;
				seed = _v2;
			...
			A3(
				...
				_user$project$Canvas$beginPath(
					A2(
						...
						2,
						A5(_user$project$Canvas$clearRect, 0, 0, _user$project$Examples_TiledLines$w, _user$project$Examples_TiledLines$h, _user$project$Canvas$empty))))));
};
...
var _user$project$Examples_TiledLines$Model = function (a) {
	return {seed: a};
};
