...
var _user$project$Examples_TiledLines$drawLine = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '::',
		_0: A2(_user$project$Canvas$moveTo, _p1._0._0, _p1._0._1),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Canvas$lineTo, _p1._1._0, _p1._1._1),
			_1: {ctor: '[]'}
		}
	};
};
...
var _user$project$Examples_TiledLines$w = 500;
var _user$project$Examples_TiledLines$cols = (_user$project$Examples_TiledLines$w / _user$project$Examples_TiledLines$step) | 0;
var _user$project$Examples_TiledLines$h = 500;
var _user$project$Examples_TiledLines$view = function (model) {
	return A4(
		_user$project$Canvas$element,
		_user$project$Examples_TiledLines$w,
		_user$project$Examples_TiledLines$h,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A4(_user$project$Canvas$clearRect, 0, 0, _user$project$Examples_TiledLines$w, _user$project$Examples_TiledLines$h),
			_1: {
				ctor: '::',
...
var _user$project$Examples_TiledLines$rows = (_user$project$Examples_TiledLines$h / _user$project$Examples_TiledLines$step) | 0;
var _user$project$Examples_TiledLines$drawLines = F3(
	function (seed, i, cmds) {
		drawLines:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(i, _user$project$Examples_TiledLines$cols * _user$project$Examples_TiledLines$rows) > 0) {
				return cmds;
			} else {
				var y = (i / _user$project$Examples_TiledLines$rows) | 0;
				var x = A2(_elm_lang$core$Basics_ops['%'], i, _user$project$Examples_TiledLines$cols);
				var _p2 = A5(
					_user$project$Examples_TiledLines$randomLine,
					seed,
					_elm_lang$core$Basics$toFloat(x) * _user$project$Examples_TiledLines$step,
					_elm_lang$core$Basics$toFloat(y) * _user$project$Examples_TiledLines$step,
					_user$project$Examples_TiledLines$step,
					_user$project$Examples_TiledLines$step);
				var line = _p2._0;
				var seed2 = _p2._1;
				var lineCmds = _user$project$Examples_TiledLines$drawLine(line);
				var _v1 = seed2,
					_v2 = i + 1,
					_v3 = _elm_lang$core$List$concat(
					{
						ctor: '::',
						_0: lineCmds,
						_1: {
...
var _user$project$Examples_TiledLines$update = F2(
	function (msg, model) {
		var _p3 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
				model,
				{
					draw: _user$project$Canvas$batch(
						A3(
							_user$project$Examples_TiledLines$drawLines,
							model.seed,
							0,
							{ctor: '[]'}))
				}),
...
var _user$project$Examples_TiledLines$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Examples_TiledLines$Model = F2(
	function (a, b) {
		return {seed: a, draw: b};
	});
var _user$project$Examples_TiledLines$AnimationFrame = function (a) {
	return {ctor: 'AnimationFrame', _0: a};
};
var _user$project$Examples_TiledLines$init = function (floatSeed) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			seed: _elm_lang$core$Random$initialSeed(
				_elm_lang$core$Basics$floor(floatSeed * 10000)),
			draw: _user$project$Canvas$batch(
				{ctor: '[]'})
		},
		{
			...
			_0: A2(
				_elm_lang$core$Task$perform,
				_user$project$Examples_TiledLines$AnimationFrame,
				_elm_lang$core$Task$succeed(0)),
			_1: {ctor: '[]'}
		});
};
var _user$project$Examples_TiledLines$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Examples_TiledLines$init, update: _user$project$Examples_TiledLines$update, subscriptions: _user$project$Examples_TiledLines$subscriptions, view: _user$project$Examples_TiledLines$view})(_elm_lang$core$Json_Decode$float);

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['TiledLines'] = Elm['Examples']['TiledLines'] || {};
if (typeof _user$project$Examples_TiledLines$main !== 'undefined') {
    _user$project$Examples_TiledLines$main(Elm['Examples']['TiledLines'], 'Examples.TiledLines', undefined);
}
