...
var _user$project$Examples_CirclePacking$viewCircle = F2(
	function (circle, cmds) {
...
var _user$project$Examples_CirclePacking$view = function (model) {
	return A4(
		...
		function (cmds) {
			return A3(_elm_lang$core$List$foldl, _user$project$Examples_CirclePacking$viewCircle, cmds, model.circles);
		}(
			A2(
				...
				A2(
					...
					A2(
						...
						2,
						A5(_user$project$Canvas$clearRect, 0, 0, _user$project$Examples_CirclePacking$w, _user$project$Examples_CirclePacking$h, _user$project$Canvas$empty))))));
};
