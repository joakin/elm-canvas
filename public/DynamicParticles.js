...
var _user$project$Examples_DynamicParticles$viewParticle = function (_p0) {
	var _p1 = _p0;
	return _user$project$Canvas$batch(
		{
			ctor: '::',
			_0: _user$project$Canvas$fillStyle(_p1.color),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Canvas$fillCircle, _p1.cx, _p1.cy, _p1.r),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Examples_DynamicParticles$view = function (model) {
	var _p2 = model;
	if (_p2.ctor === 'Init') {
		return _elm_lang$html$Html$text('');
	} else {
		var _p3 = _p2._0.canvas;
		return A4(
			...
			},
			{
				ctor: '::',
				_0: A4(
					_user$project$Canvas$clearRect,
					0,
					0,
				...
				_1: {
					...
					_0: _user$project$Canvas$batch(
						A2(_elm_lang$core$List$map, _user$project$Examples_DynamicParticles$viewParticle, _p2._0.particles)),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _user$project$Examples_DynamicParticles$pointToParticle = function (_p4) {
	var _p5 = _p4;
	var _p7 = _p5._1;
	var _p6 = _p5._0;
	return {
		origin: {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$toFloat(_p6),
			_1: _elm_lang$core$Basics$toFloat(_p7)
		},
		cx: _elm_lang$core$Basics$toFloat(_p6),
		cy: _elm_lang$core$Basics$toFloat(_p7),
		vx: 0,
		vy: 0,
		r: 2,
		rMax: 5,
...
var _user$project$Examples_DynamicParticles$pointDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (list) {
		var _p8 = list;
		if (((_p8.ctor === '::') && (_p8._1.ctor === '::')) && (_p8._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Json_Decode$fail('Did not recieve a pair');
		}
	},
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int));
var _user$project$Examples_DynamicParticles$sizeDecoder = A3(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$int));
var _user$project$Examples_DynamicParticles$flagDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
	...
	A2(
		...
		_user$project$Examples_DynamicParticles$sizeDecoder),
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
		...
		_elm_lang$core$Json_Decode$list(_user$project$Examples_DynamicParticles$pointDecoder)));
var _user$project$Examples_DynamicParticles$isGrowing = function (_p9) {
	var _p10 = _p9;
	return _elm_lang$core$Native_Utils.cmp(_p10.r, _p10.rMax) < 0;
};
var _user$project$Examples_DynamicParticles$updateHealth = function (particle) {
	return (_user$project$Examples_DynamicParticles$isGrowing(particle) && (!particle.dying)) ? _elm_lang$core$Native_Utils.update(
		particle,
		{r: particle.r + particle.duration}) : _elm_lang$core$Native_Utils.update(
		particle,
		{r: particle.r - particle.duration, dying: true});
};
var _user$project$Examples_DynamicParticles$isDead = function (_p11) {
	var _p12 = _p11;
	return _elm_lang$core$Native_Utils.cmp(_p12.r, 1) < 0;
};
var _user$project$Examples_DynamicParticles$isOffCanvas = F2(
	function (_p14, _p13) {
		var _p15 = _p14;
		var _p16 = _p13;
		var _p17 = _p16.cy;
		return (_elm_lang$core$Native_Utils.cmp(_p17, 0) < 0) || (_elm_lang$core$Native_Utils.cmp(
			_p17,
			_elm_lang$core$Basics$toFloat(_p15.height)) > 0);
	});
var _user$project$Examples_DynamicParticles$getSpeed = function (_p18) {
	var _p19 = _p18;
	var _p21 = _p19.vy;
	var _p20 = _p19.vx;
	return _elm_lang$core$Basics$sqrt((_p20 * _p20) + (_p21 * _p21));
};
var _user$project$Examples_DynamicParticles$setHeading = F2(
	function (heading, particle) {
		var speed = _user$project$Examples_DynamicParticles$getSpeed(particle);
		return _elm_lang$core$Native_Utils.update(
			particle,
			{
				vx: _elm_lang$core$Basics$cos(heading) * speed,
				vy: _elm_lang$core$Basics$sin(heading) * speed
			});
	});
var _user$project$Examples_DynamicParticles$generateColor = A2(
	_elm_lang$core$Random$map,
	_elm_lang$core$Maybe$withDefault(
		A3(_elm_lang$core$Color$rgb, 252, 191, 73)),
	A2(
		_elm_lang$core$Random$map,
		_elm_lang$core$Tuple$first,
		_elm_community$random_extra$Random_List$choose(
			{
				ctor: '::',
				_0: A3(_elm_lang$core$Color$rgb, 0, 48, 73),
				_1: {
					ctor: '::',
					_0: A3(_elm_lang$core$Color$rgb, 73, 214, 40),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$core$Color$rgb, 247, 127, 0),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$core$Color$rgb, 252, 191, 73),
							_1: {
								ctor: '::',
								_0: A3(_elm_lang$core$Color$rgb, 234, 226, 183),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Examples_DynamicParticles$generateHeading = A2(
	_elm_lang$core$Random$float,
	_elm_lang$core$Basics$degrees(0),
	_elm_lang$core$Basics$degrees(360));
var _user$project$Examples_DynamicParticles$generateRadius = function (_p22) {
	var _p23 = _p22;
	var _p24 = _p23.r;
	return A2(_elm_lang$core$Random$float, _p24, _p24 + 3);
};
var _user$project$Examples_DynamicParticles$generateParticle = function (particle) {
	return A4(
		_elm_lang$core$Random$map3,
		F3(
			function (newR, heading, newColor) {
				return A2(
					_user$project$Examples_DynamicParticles$setHeading,
					heading,
					_elm_lang$core$Native_Utils.update(
						particle,
						{rMax: newR, color: newColor}));
			}),
		_user$project$Examples_DynamicParticles$generateRadius(particle),
		_user$project$Examples_DynamicParticles$generateHeading,
		_user$project$Examples_DynamicParticles$generateColor);
};
var _user$project$Examples_DynamicParticles$updatePosition = F2(
	function (canvas, particle) {
		return (A2(_user$project$Examples_DynamicParticles$isOffCanvas, canvas, particle) || _user$project$Examples_DynamicParticles$isDead(particle)) ? _user$project$Examples_DynamicParticles$generateParticle(
			_elm_lang$core$Native_Utils.update(
				particle,
				{
					cx: _elm_lang$core$Tuple$first(particle.origin),
					cy: _elm_lang$core$Tuple$second(particle.origin),
					vx: particle.vx,
					vy: particle.vy,
					r: 2,
					dying: false
			...
			_elm_lang$core$Native_Utils.update(
				particle,
				{cx: particle.cx + particle.vx, cy: particle.cy + particle.vy, vx: particle.vx * particle.friction, vy: particle.vy * particle.friction}));
	});
var _user$project$Examples_DynamicParticles$updateParticle = F3(
	function (isInit, canvas, particle) {
		return isInit ? _user$project$Examples_DynamicParticles$generateParticle(
			_elm_lang$core$Native_Utils.update(
				particle,
				{
					cx: _elm_lang$core$Tuple$first(particle.origin),
			...
			_user$project$Examples_DynamicParticles$updatePosition,
			canvas,
			_user$project$Examples_DynamicParticles$updateHealth(particle));
	});
var _user$project$Examples_DynamicParticles$Canvas = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _user$project$Examples_DynamicParticles$Particle = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {origin: a, cx: b, cy: c, vx: d, vy: e, r: f, rMax: g, friction: h, gravity: i, color: j, dying: k, duration: l};
											};
										};
									};
								};
...
var _user$project$Examples_DynamicParticles$Go = function (a) {
	return {ctor: 'Go', _0: a};
};
var _user$project$Examples_DynamicParticles$Init = function (a) {
	return {ctor: 'Init', _0: a};
};
var _user$project$Examples_DynamicParticles$Generated = function (a) {
	return {ctor: 'Generated', _0: a};
};
var _user$project$Examples_DynamicParticles$init = function (json) {
	var _p25 = function () {
		var _p26 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Examples_DynamicParticles$flagDecoder, json);
		if (_p26.ctor === 'Ok') {
			return _p26._0;
		} else {
			return {
	...
	var points = _p25._1;
	var canvas = {
		width: _elm_lang$core$Tuple$first(size),
		height: _elm_lang$core$Tuple$second(size)
	};
	return {
		ctor: '_Tuple2',
		_0: _user$project$Examples_DynamicParticles$Init(canvas),
		_1: A2(
			_elm_lang$core$Random$generate,
			_user$project$Examples_DynamicParticles$Generated,
			_elm_community$random_extra$Random_Extra$combine(
				A2(
					_elm_lang$core$List$map,
					A2(_user$project$Examples_DynamicParticles$updateParticle, true, canvas),
					A2(_elm_lang$core$List$map, _user$project$Examples_DynamicParticles$pointToParticle, points))))
	};
};
var _user$project$Examples_DynamicParticles$update = F2(
	function (msg, model) {
		var _p27 = msg;
		if (_p27.ctor === 'Tick') {
			var _p28 = model;
				...
				return {
					...
					_1: A2(
						...
						_elm_community$random_extra$Random_Extra$combine(
							A2(
								_elm_lang$core$List$map,
								A2(_user$project$Examples_DynamicParticles$updateParticle, false, _p28._0.canvas),
								_p28._0.particles)))
				};
			}
		} else {
			...
			if (_p29.ctor === 'Init') {
				return {
					ctor: '_Tuple2',
					_0: _user$project$Examples_DynamicParticles$Go(
						{canvas: _p29._0, particles: _p30}),
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Examples_DynamicParticles$Go(
						{canvas: _p29._0.canvas, particles: _p30}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			}
		}
	});
var _user$project$Examples_DynamicParticles$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Examples_DynamicParticles$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$Examples_DynamicParticles$init,
		view: _user$project$Examples_DynamicParticles$view,
		update: _user$project$Examples_DynamicParticles$update,
		subscriptions: function (_p31) {
			return _elm_lang$animation_frame$AnimationFrame$times(_user$project$Examples_DynamicParticles$Tick);
		}
	})(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['DynamicParticles'] = Elm['Examples']['DynamicParticles'] || {};
if (typeof _user$project$Examples_DynamicParticles$main !== 'undefined') {
    _user$project$Examples_DynamicParticles$main(Elm['Examples']['DynamicParticles'], 'Examples.DynamicParticles', undefined);
}
