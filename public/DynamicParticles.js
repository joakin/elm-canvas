...
var _user$project$Examples_DynamicParticles$viewParticle = F2(
	function (_p0, cmds) {
		var _p1 = _p0;
		return A4(
			...
			_p1.cy,
			_p1.r,
			A2(_user$project$Canvas$fillStyle, _p1.color, cmds));
	});
var _user$project$Examples_DynamicParticles$view = function (model) {
	...
	if (_p2.ctor === 'Init') {
		...
		return A4(
			...
			function (cmds) {
				return A3(_elm_lang$core$List$foldl, _user$project$Examples_DynamicParticles$viewParticle, cmds, _p2._0.particles);
			}(
				A5(
