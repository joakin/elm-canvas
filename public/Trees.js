...
var _ianmackenzie$elm_geometry$LineSegment2d$endpoints = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _ianmackenzie$elm_geometry$LineSegment2d$interpolate = function (lineSegment) {
	var _p2 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment);
	var start = _p2._0;
	var end = _p2._1;
	return A2(_ianmackenzie$elm_geometry$Point2d$interpolateFrom, start, end);
};
var _ianmackenzie$elm_geometry$LineSegment2d$midpoint = function (lineSegment) {
	return A2(_ianmackenzie$elm_geometry$LineSegment2d$interpolate, lineSegment, 0.5);
};
var _ianmackenzie$elm_geometry$LineSegment2d$vector = function (lineSegment) {
	var _p3 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment);
	var p1 = _p3._0;
	var p2 = _p3._1;
	return A2(_ianmackenzie$elm_geometry$Vector2d$from, p1, p2);
};
var _ianmackenzie$elm_geometry$LineSegment2d$length = function (_p4) {
	return _ianmackenzie$elm_geometry$Vector2d$length(
		_ianmackenzie$elm_geometry$LineSegment2d$vector(_p4));
};
var _ianmackenzie$elm_geometry$LineSegment2d$squaredLength = function (_p5) {
	return _ianmackenzie$elm_geometry$Vector2d$squaredLength(
		_ianmackenzie$elm_geometry$LineSegment2d$vector(_p5));
};
var _ianmackenzie$elm_geometry$LineSegment2d$direction = function (_p6) {
	return _ianmackenzie$elm_geometry$Vector2d$direction(
		_ianmackenzie$elm_geometry$LineSegment2d$vector(_p6));
};
var _ianmackenzie$elm_geometry$LineSegment2d$perpendicularDirection = function (_p7) {
	return _ianmackenzie$elm_geometry$Vector2d$direction(
		_ianmackenzie$elm_geometry$Vector2d$perpendicularTo(
			_ianmackenzie$elm_geometry$LineSegment2d$vector(_p7)));
};
var _ianmackenzie$elm_geometry$LineSegment2d$intersectionPoint = F2(
	function (lineSegment1, lineSegment2) {
		var s = _ianmackenzie$elm_geometry$LineSegment2d$vector(lineSegment2);
		var r = _ianmackenzie$elm_geometry$LineSegment2d$vector(lineSegment1);
		var _p8 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment2);
		var q = _p8._0;
		var q_ = _p8._1;
		var _p9 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment1);
		var p = _p9._0;
		var p_ = _p9._1;
		var pq = A2(_ianmackenzie$elm_geometry$Vector2d$from, p, q);
		var pqXr = A2(_ianmackenzie$elm_geometry$Vector2d$crossProduct, pq, r);
		var pqXs = A2(_ianmackenzie$elm_geometry$Vector2d$crossProduct, pq, s);
		var pq_ = A2(_ianmackenzie$elm_geometry$Vector2d$from, p, q_);
		var rXpq_ = A2(_ianmackenzie$elm_geometry$Vector2d$crossProduct, r, pq_);
		var uDenominator = pqXr + rXpq_;
		var qp_ = A2(_ianmackenzie$elm_geometry$Vector2d$from, q, p_);
		var sXqp_ = A2(_ianmackenzie$elm_geometry$Vector2d$crossProduct, s, qp_);
		...
		if (_elm_lang$core$Native_Utils.eq(tDenominator, 0) || _elm_lang$core$Native_Utils.eq(uDenominator, 0)) {
			return (_elm_lang$core$Native_Utils.cmp(
				A2(_ianmackenzie$elm_geometry$Vector2d$dotProduct, r, s),
			...
			if (((_elm_lang$core$Native_Utils.cmp(0, t) < 1) && (_elm_lang$core$Native_Utils.cmp(t, 1) < 1)) && ((_elm_lang$core$Native_Utils.cmp(0, u) < 1) && (_elm_lang$core$Native_Utils.cmp(u, 1) < 1))) {
				var intersection = (_elm_lang$core$Native_Utils.cmp(
					...
					A2(_elm_lang$core$Basics$min, u, 1 - u)) < 1) ? A2(_ianmackenzie$elm_geometry$LineSegment2d$interpolate, lineSegment1, t) : A2(_ianmackenzie$elm_geometry$LineSegment2d$interpolate, lineSegment2, u);
...
var _ianmackenzie$elm_geometry$LineSegment2d$boundingBox = function (lineSegment) {
	var _p10 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment);
	var p1 = _p10._0;
	var p2 = _p10._1;
	return A2(_ianmackenzie$elm_geometry$BoundingBox2d$from, p1, p2);
};
var _ianmackenzie$elm_geometry$LineSegment2d$endPoint = function (_p11) {
	var _p12 = _p11;
	return _p12._0._1;
};
var _ianmackenzie$elm_geometry$LineSegment2d$startPoint = function (_p13) {
	var _p14 = _p13;
	return _p14._0._0;
};
var _ianmackenzie$elm_geometry$LineSegment2d$fromEndpoints = _ianmackenzie$elm_geometry$Geometry_Types$LineSegment2d;
var _ianmackenzie$elm_geometry$LineSegment2d$from = F2(
	function (startPoint_, endPoint_) {
		return _ianmackenzie$elm_geometry$LineSegment2d$fromEndpoints(
			{ctor: '_Tuple2', _0: startPoint_, _1: endPoint_});
	});
var _ianmackenzie$elm_geometry$LineSegment2d$along = F3(
	function (axis, start, end) {
		return _ianmackenzie$elm_geometry$LineSegment2d$fromEndpoints(
			{
				ctor: '_Tuple2',
				_0: A2(_ianmackenzie$elm_geometry$Point2d$along, axis, start),
				_1: A2(_ianmackenzie$elm_geometry$Point2d$along, axis, end)
			});
	});
var _ianmackenzie$elm_geometry$LineSegment2d$reverse = function (lineSegment) {
	var _p15 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment);
	var p1 = _p15._0;
	var p2 = _p15._1;
	return _ianmackenzie$elm_geometry$LineSegment2d$fromEndpoints(
		{ctor: '_Tuple2', _0: p2, _1: p1});
};
var _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints = F2(
	function ($function, lineSegment) {
		var _p16 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(lineSegment);
		var p1 = _p16._0;
		var p2 = _p16._1;
		return _ianmackenzie$elm_geometry$LineSegment2d$fromEndpoints(
			{
...
var _ianmackenzie$elm_geometry$LineSegment2d$scaleAbout = F2(
	function (point, scale) {
		return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
			A2(_ianmackenzie$elm_geometry$Point2d$scaleAbout, point, scale));
	});
var _ianmackenzie$elm_geometry$LineSegment2d$rotateAround = F2(
	function (centerPoint, angle) {
		return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
			A2(_ianmackenzie$elm_geometry$Point2d$rotateAround, centerPoint, angle));
	});
var _ianmackenzie$elm_geometry$LineSegment2d$translateBy = function (displacementVector) {
	return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
		_ianmackenzie$elm_geometry$Point2d$translateBy(displacementVector));
};
var _ianmackenzie$elm_geometry$LineSegment2d$translateIn = F3(
	function (translationDirection, distance, lineSegment) {
		return A2(
			_ianmackenzie$elm_geometry$LineSegment2d$translateBy,
			A2(_ianmackenzie$elm_geometry$Vector2d$withLength, distance, translationDirection),
			lineSegment);
	});
var _ianmackenzie$elm_geometry$LineSegment2d$mirrorAcross = function (axis) {
	return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
		_ianmackenzie$elm_geometry$Point2d$mirrorAcross(axis));
};
var _ianmackenzie$elm_geometry$LineSegment2d$projectOnto = function (axis) {
	return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
		_ianmackenzie$elm_geometry$Point2d$projectOnto(axis));
};
var _ianmackenzie$elm_geometry$LineSegment2d$relativeTo = function (frame) {
	return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
		_ianmackenzie$elm_geometry$Point2d$relativeTo(frame));
};
var _ianmackenzie$elm_geometry$LineSegment2d$placeIn = function (frame) {
	return _ianmackenzie$elm_geometry$LineSegment2d$mapEndpoints(
		_ianmackenzie$elm_geometry$Point2d$placeIn(frame));
};
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string('function')
				},
				_1: {
					ctor: '::',
					_0: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'args',
							_1: _elm_lang$core$Json_Encode$list(args)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Canvas$field = F2(
	function (name, value) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
...
var _user$project$Canvas$element = F4(
	function (w, h, attrs, cmds) {
		return A3(
			...
			{
				ctor: '::',
				_0: _user$project$Canvas$commands(cmds),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Canvas$Saturation = {ctor: 'Saturation'};
var _user$project$Canvas$Hue = {ctor: 'Hue'};
var _user$project$Canvas$Exclusion = {ctor: 'Exclusion'};
var _user$project$Canvas$Difference = {ctor: 'Difference'};
var _user$project$Canvas$SoftLight = {ctor: 'SoftLight'};
var _user$project$Canvas$HardLight = {ctor: 'HardLight'};
var _user$project$Canvas$ColorBurn = {ctor: 'ColorBurn'};
var _user$project$Canvas$ColorDodge = {ctor: 'ColorDodge'};
var _user$project$Canvas$Lighten = {ctor: 'Lighten'};
var _user$project$Canvas$Darken = {ctor: 'Darken'};
var _user$project$Canvas$Overlay = {ctor: 'Overlay'};
var _user$project$Canvas$Screen = {ctor: 'Screen'};
var _user$project$Canvas$Multiply = {ctor: 'Multiply'};
var _user$project$Canvas$Xor = {ctor: 'Xor'};
var _user$project$Canvas$Copy = {ctor: 'Copy'};
var _user$project$Canvas$Lighter = {ctor: 'Lighter'};
var _user$project$Canvas$DestinationAtop = {ctor: 'DestinationAtop'};
var _user$project$Canvas$DestinationOut = {ctor: 'DestinationOut'};
var _user$project$Canvas$DestinationIn = {ctor: 'DestinationIn'};
var _user$project$Canvas$DestinationOver = {ctor: 'DestinationOver'};
var _user$project$Canvas$SourceAtop = {ctor: 'SourceAtop'};
var _user$project$Canvas$SourceOut = {ctor: 'SourceOut'};
var _user$project$Canvas$SourceIn = {ctor: 'SourceIn'};
var _user$project$Canvas$SourceOver = {ctor: 'SourceOver'};
var _user$project$Canvas$SquareCap = {ctor: 'SquareCap'};
var _user$project$Canvas$RoundCap = {ctor: 'RoundCap'};
var _user$project$Canvas$ButtCap = {ctor: 'ButtCap'};
var _user$project$Canvas$MiterJoin = {ctor: 'MiterJoin'};
var _user$project$Canvas$RoundJoin = {ctor: 'RoundJoin'};
var _user$project$Canvas$BevelJoin = {ctor: 'BevelJoin'};
var _user$project$Canvas$End = {ctor: 'End'};
var _user$project$Canvas$Start = {ctor: 'Start'};
var _user$project$Canvas$Center = {ctor: 'Center'};
var _user$project$Canvas$Right = {ctor: 'Right'};
var _user$project$Canvas$Left = {ctor: 'Left'};
var _user$project$Canvas$Bottom = {ctor: 'Bottom'};
var _user$project$Canvas$Ideographic = {ctor: 'Ideographic'};
var _user$project$Canvas$Alphabetic = {ctor: 'Alphabetic'};
var _user$project$Canvas$Middle = {ctor: 'Middle'};
var _user$project$Canvas$Hanging = {ctor: 'Hanging'};
...
var _user$project$Examples_Trees$split = function (_p0) {
	var _p1 = _p0;
	var _p9 = _p1.line;
	var _p8 = _p1.life;
	var _p2 = A2(
	...
	var p1 = _p2._0;
	var seed2 = _p2._1;
	var shouldSplit = _elm_lang$core$Native_Utils.cmp(p1, 0.98) > 0;
	var _p3 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(_p9);
	var start = _p3._0;
	var end = _p3._1;
	if (shouldSplit) {
		var _p4 = A2(
			...
			A2(
				_elm_lang$core$Random$step,
				A2(_elm_lang$core$Random$int, 0, 10000),
				seed2));
		var childSeed = _p4._0;
		var seed3 = _p4._1;
		var _p5 = A2(
			_elm_lang$core$Tuple$mapFirst,
			_elm_lang$core$Random$initialSeed,
			A2(
				...
				A2(_elm_lang$core$Random$int, 0, 10000),
				seed3));
		var childSeed2 = _p5._0;
		var seed4 = _p5._1;
		var _p6 = A2(
			_elm_lang$core$Random$step,
			A2(_elm_lang$core$Random$float, -45, 45),
			seed4);
		var degrees1 = _p6._0;
		var seed5 = _p6._1;
		var _p7 = A2(
		...
		return {
			...
			_0: {
				...
				_0: {
					line: A3(
						_ianmackenzie$elm_geometry$LineSegment2d$rotateAround,
						start,
						_elm_lang$core$Basics$degrees(degrees1),
						_p9),
					life: _p8 - 10,
					seed: childSeed
				},
				_1: {
					...
					_0: {
						line: A3(
							_ianmackenzie$elm_geometry$LineSegment2d$rotateAround,
							start,
							_elm_lang$core$Basics$degrees(degrees2),
							_p9),
						life: _p8 - 10,
						seed: childSeed2
					},
...
var _user$project$Examples_Trees$padding = 20;
var _user$project$Examples_Trees$w = 500;
var _user$project$Examples_Trees$treeLocation = A2(_elm_lang$core$Random$float, _user$project$Examples_Trees$w * 0.2, _user$project$Examples_Trees$w * 0.8);
var _user$project$Examples_Trees$h = 500;
var _user$project$Examples_Trees$initWithSeed = function (seed) {
	var _p10 = A2(_elm_lang$core$Random$step, _user$project$Examples_Trees$treeLocation, seed);
	var randomX = _p10._0;
	var seed2 = _p10._1;
	var treeStart = _ianmackenzie$elm_geometry$Point2d$fromCoordinates(
		{ctor: '_Tuple2', _0: randomX, _1: _user$project$Examples_Trees$h});
	var end = _ianmackenzie$elm_geometry$Point2d$fromCoordinates(
		{ctor: '_Tuple2', _0: randomX, _1: _user$project$Examples_Trees$h - 5});
	var _p11 = A2(
		_elm_lang$core$Tuple$mapFirst,
		_elm_lang$core$Random$initialSeed,
		A2(
			...
			A2(_elm_lang$core$Random$int, 0, 10000),
			seed2));
	var randomTreeSeed = _p11._0;
	var seed3 = _p11._1;
	var _p12 = A2(
		_elm_lang$core$Random$step,
		A2(
			_elm_lang$core$Random$int,
			_elm_lang$core$Basics$round(_user$project$Examples_Trees$h * 0.7),
			_user$project$Examples_Trees$h),
		seed3);
	var life = _p12._0;
	var seed4 = _p12._1;
	var initialPoints = {
		...
		_0: {
			seed: randomTreeSeed,
			line: _ianmackenzie$elm_geometry$LineSegment2d$fromEndpoints(
				{ctor: '_Tuple2', _0: treeStart, _1: end}),
			life: life
		},
		_1: {ctor: '[]'}
	};
	return {
		ctor: '_Tuple2',
		_0: {brushes: initialPoints, seed: seed4},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Examples_Trees$init = function (floatSeed) {
	return _user$project$Examples_Trees$initWithSeed(
		_elm_lang$core$Random$initialSeed(
			_elm_lang$core$Basics$round(floatSeed * 10000)));
};
var _user$project$Examples_Trees$outOfBounds = function (_p13) {
	var _p14 = _p13;
	var end = _ianmackenzie$elm_geometry$LineSegment2d$endPoint(_p14.line);
	var _p15 = _ianmackenzie$elm_geometry$Point2d$coordinates(end);
	var x = _p15._0;
	var y = _p15._1;
	return (_elm_lang$core$Native_Utils.cmp(x, _user$project$Examples_Trees$w - _user$project$Examples_Trees$padding) > -1) || ((_elm_lang$core$Native_Utils.cmp(x, _user$project$Examples_Trees$padding) < 1) || ((_elm_lang$core$Native_Utils.cmp(y, _user$project$Examples_Trees$h) > 0) || (_elm_lang$core$Native_Utils.cmp(y, _user$project$Examples_Trees$padding) < 1)));
};
var _user$project$Examples_Trees$updateBrush = function (brush) {
	var _p16 = _user$project$Examples_Trees$split(brush);
	var children = _p16._0;
	var nextSeed = _p16._1;
	var _p17 = A2(
		_elm_lang$core$Random$step,
		A2(_elm_lang$core$Random$int, 0, 10),
		nextSeed);
	var loseLife = _p17._0;
	var nextSeed2 = _p17._1;
	var _p18 = brush;
	var line = _p18.line;
	var seed = _p18.seed;
	var life = _p18.life;
	var displacement = A2(
		_ianmackenzie$elm_geometry$Vector2d$scaleBy,
		0.8,
		_ianmackenzie$elm_geometry$LineSegment2d$vector(line));
	var movedLine = A2(_ianmackenzie$elm_geometry$LineSegment2d$translateBy, displacement, line);
	var movedBrush = {seed: nextSeed2, line: movedLine, life: life - loseLife};
	return (_user$project$Examples_Trees$outOfBounds(movedBrush) || (_elm_lang$core$Native_Utils.cmp(life, 0) < 1)) ? children : {ctor: '::', _0: movedBrush, _1: children};
};
var _user$project$Examples_Trees$update = F2(
	function (msg, model) {
		var _p19 = msg;
		return _elm_lang$core$List$isEmpty(model.brushes) ? _user$project$Examples_Trees$initWithSeed(model.seed) : A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
				model,
				{
					brushes: A2(_elm_lang$core$List$concatMap, _user$project$Examples_Trees$updateBrush, model.brushes)
				}),
			{ctor: '[]'});
	});
var _user$project$Examples_Trees$paint = function (_p20) {
	var _p21 = _p20;
	var _p22 = _ianmackenzie$elm_geometry$LineSegment2d$endpoints(_p21.line);
	var start = _p22._0;
	var end = _p22._1;
	return _user$project$Canvas$batch(
		{
			ctor: '::',
			_0: _user$project$Canvas$lineWidth(
				(30 * _elm_lang$core$Basics$toFloat(_p21.life)) / _user$project$Examples_Trees$h),
			_1: {
				ctor: '::',
				_0: _user$project$Canvas$beginPath,
				_1: {
					...
					_0: A2(
						...
						_ianmackenzie$elm_geometry$Point2d$xCoordinate(start),
						_ianmackenzie$elm_geometry$Point2d$yCoordinate(start)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Canvas$lineTo,
							_ianmackenzie$elm_geometry$Point2d$xCoordinate(end),
							_ianmackenzie$elm_geometry$Point2d$yCoordinate(end)),
						_1: {
							ctor: '::',
							_0: _user$project$Canvas$stroke,
							_1: {ctor: '[]'}
...
var _user$project$Examples_Trees$view = function (model) {
	return A4(
		_user$project$Canvas$element,
		_user$project$Examples_Trees$w,
		_user$project$Examples_Trees$h,
		{
			ctor: '::',
		...
		_elm_lang$core$List$isEmpty(model.brushes) ? {
			ctor: '::',
			_0: _user$project$Canvas$fillStyle(
				A4(_elm_lang$core$Color$rgba, 255, 255, 255, 5.0e-2)),
			_1: {
				ctor: '::',
				_0: A4(_user$project$Canvas$fillRect, 0, 0, _user$project$Examples_Trees$w, _user$project$Examples_Trees$h),
				_1: {ctor: '[]'}
			}
		} : {
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Canvas$fillStyle(
					A4(_elm_lang$core$Color$rgba, 255, 255, 255, 8.0e-3)),
				_1: {
					ctor: '::',
					_0: A4(_user$project$Canvas$fillRect, 0, 0, _user$project$Examples_Trees$w, _user$project$Examples_Trees$h),
					_1: {
						...
						_0: _user$project$Canvas$batch(
							A2(_elm_lang$core$List$map, _user$project$Examples_Trees$paint, model.brushes)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Examples_Trees$Brush = F3(
	function (a, b, c) {
		return {seed: a, line: b, life: c};
	});
var _user$project$Examples_Trees$Model = F2(
	function (a, b) {
		return {brushes: a, seed: b};
	});
var _user$project$Examples_Trees$AnimationFrame = function (a) {
	return {ctor: 'AnimationFrame', _0: a};
};
var _user$project$Examples_Trees$subscriptions = function (model) {
	return _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Examples_Trees$AnimationFrame);
};
var _user$project$Examples_Trees$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Examples_Trees$init, update: _user$project$Examples_Trees$update, subscriptions: _user$project$Examples_Trees$subscriptions, view: _user$project$Examples_Trees$view})(_elm_lang$core$Json_Decode$float);

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['Trees'] = Elm['Examples']['Trees'] || {};
if (typeof _user$project$Examples_Trees$main !== 'undefined') {
    _user$project$Examples_Trees$main(Elm['Examples']['Trees'], 'Examples.Trees', undefined);
}
