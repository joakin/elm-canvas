...
var _user$project$Examples_Template$view = function (model) {
	return A4(
		...
		{
			ctor: '::',
			_0: A4(_user$project$Canvas$clearRect, 0, 0, _user$project$Examples_Template$w, _user$project$Examples_Template$h),
			_1: {
				ctor: '::',
				_0: _user$project$Canvas$font('48px sans-serif'),
				_1: {
					ctor: '::',
					_0: _user$project$Canvas$textAlign(_user$project$Canvas$Center),
					_1: {
						ctor: '::',
