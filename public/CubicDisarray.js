...
var _user$project$Examples_CubicDisarray$randomFloat = A2(_elm_lang$core$Random$float, 0, 1);
var _user$project$Examples_CubicDisarray$fourRandomFloats = A5(
	_elm_lang$core$Random$map4,
	F4(
		function (r1, r2, r3, r4) {
			return {ctor: '_Tuple4', _0: r1, _1: r2, _2: r3, _3: r4};
		}),
	_user$project$Examples_CubicDisarray$randomFloat,
	_user$project$Examples_CubicDisarray$randomFloat,
	_user$project$Examples_CubicDisarray$randomFloat,
	_user$project$Examples_CubicDisarray$randomFloat);
var _user$project$Examples_CubicDisarray$rotateMultiplier = 45;
var _user$project$Examples_CubicDisarray$randomDisplacement = 15;
var _user$project$Examples_CubicDisarray$bg = A3(
	_elm_lang$core$Color$hsl,
	_elm_lang$core$Basics$degrees(39),
	0.19,
	0.86);
var _user$project$Examples_CubicDisarray$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Examples_CubicDisarray$init = function (floatSeed) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			ctor: '_Tuple2',
			_0: _elm_lang$core$Random$initialSeed(
				_elm_lang$core$Basics$floor(floatSeed * 1000000)),
			_1: 0
		},
		{ctor: '[]'});
};
var _user$project$Examples_CubicDisarray$rows = 20;
var _user$project$Examples_CubicDisarray$moveAround = F2(
	function (_p1, seed) {
		var _p2 = _p1;
		var _p4 = _p2._1;
		var plusOrMinus = function (r) {
			return (_elm_lang$core$Native_Utils.cmp(r, 0.5) < 0) ? -1 : 1;
		};
		var _p3 = A2(_elm_lang$core$Random$step, _user$project$Examples_CubicDisarray$fourRandomFloats, seed);
		var r1 = _p3._0._0;
		var r2 = _p3._0._1;
		var r3 = _p3._0._2;
		var r4 = _p3._0._3;
		var seed2 = _p3._1;
		var rotateAmt = (((((_p4 / _user$project$Examples_CubicDisarray$rows) * _elm_lang$core$Basics$pi) / 180) * plusOrMinus(r1)) * r2) * _user$project$Examples_CubicDisarray$rotateMultiplier;
		var translateAmt = (((_p4 / _user$project$Examples_CubicDisarray$rows) * plusOrMinus(r3)) * r4) * _user$project$Examples_CubicDisarray$randomDisplacement;
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: rotateAmt, _1: translateAmt},
			_1: seed2
		};
	});
var _user$project$Examples_CubicDisarray$cols = 12;
var _user$project$Examples_CubicDisarray$w = 500;
var _user$project$Examples_CubicDisarray$padding = _user$project$Examples_CubicDisarray$w / 6;
var _user$project$Examples_CubicDisarray$boxSize = (_user$project$Examples_CubicDisarray$w - (_user$project$Examples_CubicDisarray$padding * 2)) / _user$project$Examples_CubicDisarray$cols;
var _user$project$Examples_CubicDisarray$h = (_user$project$Examples_CubicDisarray$padding * 2) + (_user$project$Examples_CubicDisarray$rows * _user$project$Examples_CubicDisarray$boxSize);
var _user$project$Examples_CubicDisarray$drawRect = F2(
	function (_p6, _p5) {
		var _p7 = _p6;
		var _p8 = _p5;
		var _p9 = {
		...
		var xf = _p9._0;
		var yf = _p9._1;
		var _p10 = {ctor: '_Tuple2', _0: (xf * _user$project$Examples_CubicDisarray$boxSize) + _user$project$Examples_CubicDisarray$padding, _1: (yf * _user$project$Examples_CubicDisarray$boxSize) + _user$project$Examples_CubicDisarray$padding};
		var px = _p10._0;
		var py = _p10._1;
		var _p11 = A2(
			_user$project$Examples_CubicDisarray$moveAround,
			{ctor: '_Tuple2', _0: xf, _1: yf},
			_p8._1);
		var rotateAmt = _p11._0._0;
		var translateAmt = _p11._0._1;
		var newSeed = _p11._1;
		return {
			ctor: '_Tuple2',
			_0: _user$project$Canvas$restore(
				A5(
					_user$project$Canvas$strokeRect,
					0,
					0,
					_user$project$Examples_CubicDisarray$boxSize,
					_user$project$Examples_CubicDisarray$boxSize,
					A2(
						_user$project$Canvas$rotate,
						rotateAmt,
						A3(
							_user$project$Canvas$translate,
							px + translateAmt,
							py,
							_user$project$Canvas$save(_p8._0))))),
			_1: newSeed
		};
	});
var _user$project$Examples_CubicDisarray$drawRects = F2(
	function (seed, cmds) {
		return _elm_lang$core$Tuple$first(
			A3(
				_joakin$elm_grid$Grid$fold2d,
				{rows: _user$project$Examples_CubicDisarray$rows, cols: _user$project$Examples_CubicDisarray$cols},
				_user$project$Examples_CubicDisarray$drawRect,
				{ctor: '_Tuple2', _0: cmds, _1: seed}));
	});
var _user$project$Examples_CubicDisarray$view = function (_p12) {
	var _p13 = _p12;
	return A4(
		_user$project$Canvas$element,
		_user$project$Examples_CubicDisarray$w,
		_elm_lang$core$Basics$floor(_user$project$Examples_CubicDisarray$h),
		{
			ctor: '::',
		...
		A2(
			_user$project$Examples_CubicDisarray$drawRects,
			_p13._0,
			A5(
				...
				0,
				_user$project$Examples_CubicDisarray$w,
				_user$project$Examples_CubicDisarray$h,
				A2(_user$project$Canvas$fillStyle, _user$project$Examples_CubicDisarray$bg, _user$project$Canvas$empty))));
};
var _user$project$Examples_CubicDisarray$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Examples_CubicDisarray$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Examples_CubicDisarray$init, update: _user$project$Examples_CubicDisarray$update, subscriptions: _user$project$Examples_CubicDisarray$subscriptions, view: _user$project$Examples_CubicDisarray$view})(_elm_lang$core$Json_Decode$float);
var _user$project$Examples_CubicDisarray$AnimationFrame = function (a) {
	return {ctor: 'AnimationFrame', _0: a};
};

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['CubicDisarray'] = Elm['Examples']['CubicDisarray'] || {};
if (typeof _user$project$Examples_CubicDisarray$main !== 'undefined') {
    _user$project$Examples_CubicDisarray$main(Elm['Examples']['CubicDisarray'], 'Examples.CubicDisarray', undefined);
}
