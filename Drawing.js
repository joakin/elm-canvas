...
var _user$project$Examples_Drawing$col = function (btns) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A4(
					...
					_user$project$Examples_Drawing$w,
					_user$project$Examples_Drawing$h,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(_user$project$Examples_Drawing$w - 20),
											'px')
									},
									_1: {
										ctor: '::',
...
var _user$project$Examples_Drawing$AnimationFrame = function (a) {
	return {ctor: 'AnimationFrame', _0: a};
};
var _user$project$Examples_Drawing$subscriptions = function (model) {
	return _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Examples_Drawing$AnimationFrame);
};
var _user$project$Examples_Drawing$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Examples_Drawing$init, update: _user$project$Examples_Drawing$update, subscriptions: _user$project$Examples_Drawing$subscriptions, view: _user$project$Examples_Drawing$view})(_elm_lang$core$Json_Decode$float);

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['Drawing'] = Elm['Examples']['Drawing'] || {};
if (typeof _user$project$Examples_Drawing$main !== 'undefined') {
    _user$project$Examples_Drawing$main(Elm['Examples']['Drawing'], 'Examples.Drawing', undefined);
}
