	...
	var _p15 = A2(
		...
		A2(
			...
			A2(
				...
				_user$project$Examples_JoyDivision$rows,
				A2(
					_elm_lang$core$Random$list,
					_user$project$Examples_JoyDivision$cols,
	...
	var points = A2(
		...
		A3(
			...
			F2(
				function (r, p) {
					return {
						point: A2(_user$project$Examples_JoyDivision$moveAround, r, p),
						random: r
					};
				}),
			randomYs,
...
var _user$project$Examples_JoyDivision$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Examples_JoyDivision$init, update: _user$project$Examples_JoyDivision$update, subscriptions: _user$project$Examples_JoyDivision$subscriptions, view: _user$project$Examples_JoyDivision$view})(_elm_lang$core$Json_Decode$float);
var _user$project$Examples_JoyDivision$Model = F2(
	function (a, b) {
		return {count: a, points: b};
	});
var _user$project$Examples_JoyDivision$AnimationFrame = function (a) {
	return {ctor: 'AnimationFrame', _0: a};
};

var Elm = {};
Elm['Examples'] = Elm['Examples'] || {};
Elm['Examples']['JoyDivision'] = Elm['Examples']['JoyDivision'] || {};
if (typeof _user$project$Examples_JoyDivision$main !== 'undefined') {
    _user$project$Examples_JoyDivision$main(Elm['Examples']['JoyDivision'], 'Examples.JoyDivision', undefined);
}
